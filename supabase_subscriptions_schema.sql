...
VALUES 
    ...
    ('silver', 'الباقة الفضية', 0.00, 40.00, 450.00, ARRAY['تصفح خطوط المترو الأساسية', 'البحث عن محطات المترو', 'عرض جداول المواعيد والمحطات التبادلية', 'خريطة المونوريل التفاعلية الكاملة', 'إضافة تذكيرات وملاحظات للأماكن']),
    ('gold', 'الباقة الذهبية', 0.00, 60.00, 700.00, ARRAY['تصفح خطوط المترو الأساسية', 'البحث عن محطات المترو', 'عرض جداول المواعيد والمحطات التبادلية', 'خريطة المونوريل التفاعلية الكاملة', 'محرك البحث المتقدم "ازاي اروح" لخطوط المواصلات', 'إضافة تذكيرات وملاحظات للأماكن'])
