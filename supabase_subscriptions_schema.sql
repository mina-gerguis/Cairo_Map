...
VALUES 
    ...
    ('mishwar', 'باقة المشوار', 9.00, 0.00, 0.00, ARRAY['اشتراك سريع لمدة 24 ساعة', 'تصفح خطوط المترو الأساسية والبحث', 'خريطة المونوريل التفاعلية الكاملة', 'محرك البحث المتقدم "ازاي اروح" لخطوط المواصلات']),
    ('silver', 'الباقة الفضية', 0.00, 40.00, 450.00, ARRAY['تصفح خطوط المترو الأساسية', 'البحث عن محطات المترو', 'عرض جداول المواعيد والمحطات التبادلية', 'خريطة المونوريل التفاعلية الكاملة']),
    ('gold', 'الباقة الذهبية', 0.00, 60.00, 700.00, ARRAY['تصفح خطوط المترو الأساسية', 'البحث عن محطات المترو', 'عرض جداول المواعيد والمحطات التبادلية', 'خريطة المونوريل التفاعلية الكاملة', 'محرك البحث المتقدم "ازاي اروح" لخطوط المواصلات'])
