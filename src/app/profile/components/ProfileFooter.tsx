  ...
  return (
    <div className={styles.footerCard} style={{ marginBottom: "100px" }}>
      ...
      <div className={styles.socialRow}>
        ...
        <a
          href="https://www.instagram.com/map_cairo/"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.socialIconWrapper}
          title="Instagram"
        ...
        <a
          href="https://www.linkedin.com/showcase/cairo-map"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.socialIconWrapper}
          title="LinkedIn"
      ...
      <div className={styles.versionText}>v1.0.0 (260915)</div>

      <div className={styles.copyrightText}>© 2026 ماب القاهرة. جميع الحقوق محفوظة</div>
    </div>
  );
};
