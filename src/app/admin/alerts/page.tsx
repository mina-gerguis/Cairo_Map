  ...
  if (!isAdmin) {
    return (
      <div style={{ textAlign: "center", padding: "50px", marginTop: "100px", maxWidth: "400px", margin: "100px auto" }}>
        ...
        <Link href="/" className="btn btn-primary" style={{ padding: "14px 24px" }}>
            ...
            <form onSubmit={handleCreateAlert} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                <div>
                  ...
                  <select className="input-fields" value={type} onChange={e => setType(e.target.value as any)}>
                ...
                <div>
                  ...
                  <select className="input-fields" value={showType} onChange={e => setShowType(e.target.value as any)}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                <div>
                  ...
                  <select className="input-fields" value={targetPage} onChange={e => setTargetPage(e.target.value)}>
          ...
          <div style={{ overflowX: "auto" }}>
            {fetchLoading ? (
              <div style={{ textAlign: "center", padding: "40px" }}>
                <div style={{ width: "30px", height: "30px", border: "3px solid var(--border-glass)", borderTop: "3px solid var(--color-primary)", borderRadius: "50%", animation: "spin 1s linear infinite", margin: "0 auto 10px" }}></div>
