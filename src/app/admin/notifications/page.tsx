  ...
  if (!isAdmin) {
    return (
      <div style={{ textAlign: "center", padding: "50px", marginTop: "100px", maxWidth: "400px", margin: "100px auto" }}>
        ...
        <Link href="/" className="btn btn-primary" style={{ padding: "14px 24px" }}><i className="bx bx-home" style={{ fontSize: "1.2rem" }}></i><i className="bx bx-home" style={{ fontSize: "1.2rem" }}></i> العودة للرئيسية</Link>
      </div>
    );
  }
          ...
          <form onSubmit={handleBroadcast} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
              <div>
                ...
                <select className="input-fields" value={type} onChange={e => setType(e.target.value)}>
