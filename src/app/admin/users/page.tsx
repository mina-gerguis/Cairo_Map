...
export default function AdminUsersPage() {
  ...
  return (
    <div className={styles.adminContent} style={{ maxWidth: "1400px", margin: "0 auto" }}>
      ...
      <div className={styles.subPanelCard}>
        ...
        {loadingUsers ? (
          <div style={{ textAlign: "center", padding: "50px 0" }}>
            ...
            <p style={{ color: "var(--text-secondary)", fontWeight: "600" }}>جاري تحميل حسابات المستخدمين...</p>
          </div>
                      ...
                      <td className={styles.adminTd}>
                        <div className={styles.subUserBlock}>
                          ...
                          <div>
                            ...
                            <div className={styles.subUserMeta} style={{ color: "var(--accent-ios)", fontWeight: "600" }}>
        ...
        <div className={styles.subModalOverlay} onClick={() => setEditUser(null)}>
          <div className={styles.subModalBox} style={{ maxWidth: "660px" }} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSaveUserEdit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ fontSize: "0.9rem", fontWeight: "800", color: "var(--accent-ios)", borderBottom: "1px solid var(--border-glass)", paddingBottom: "6px" }}>
              ...
              <div style={{ fontSize: "0.9rem", fontWeight: "800", color: "var(--accent-ios)", borderBottom: "1px solid var(--border-glass)", paddingBottom: "6px", marginTop: "8px" }}>
        ...
        <div className={styles.subModalOverlay} onClick={() => setNotifUser(null)}>
          <div className={styles.subModalBox} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSendNotification} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <div style={{ background: "var(--bg-glass-card)", padding: "12px 16px", borderRadius: "12px", fontSize: "0.85rem", border: "1px solid var(--border-glass)" }}>
          ...
          <div className={styles.subModalBox} style={{ maxWidth: "680px" }} onClick={(e) => e.stopPropagation()}>
            ...
            {loadingTimeline ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                ...
                <p style={{ color: "var(--text-secondary)", fontWeight: "600" }}>جاري تجميع سجل الحركات والتسلسلات...</p>
              </div>
      ...
      {deleteUser && (
        <div className={styles.subModalOverlay} onClick={() => setDeleteUser(null)}>
          <div className={styles.subModalBox} style={{ maxWidth: "460px" }} onClick={(e) => e.stopPropagation()}>
            <div style={{ textAlign: "center", marginBottom: "20px" }}>
              ...
              <h3 className={styles.subModalTitle} style={{ color: "#ef4444" }}>تأكيد حذف حساب المستخدم</h3>
              <p style={{ fontSize: "0.9rem", color: "var(--text-secondary)", marginTop: "8px", lineHeight: "1.5" }}>
                هل أنت متأكد من رغبتك في حذف حساب <strong>({deleteUser.full_name || deleteUser.username})</strong> نهائياً من الموقع؟
                <br />
                <span style={{ color: "#ef4444", fontWeight: "bold" }}>⚠️ هذا الإجراء لا يمكن التراجع عنه.</span>
              </p>
            </div>
