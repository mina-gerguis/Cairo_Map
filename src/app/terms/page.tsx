      ...
      <div className="glass-panel" style={{ padding: "32px", display: "flex", flexDirection: "column", gap: "24px", lineHeight: "1.8" }}>
        <div>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: "0.95rem" }}>
            باستخدامك لتطبيق <strong style={{ color: "var(--text-primary)" }}>دفتر (Dftry)</strong>، فإنك توافق تماماً على الالتزام بشروط الاستخدام هذه. إذا كنت لا توافق على أي جزء منها، يرجى التوقف عن استخدام التطبيق فوراً.
          </p>
        </div>
        ...
        <div style={{ borderTop: "1px solid var(--border-glass)", paddingTop: "20px" }}>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: "0.95rem" }}>
            تطبيق دفتر هو دليل استرشادي للأرقام وعناوين الأماكن وفروعها. نحن نبذل قصارى جهدنا للتحقق من صحة البيانات، ولكننا لا نضمن خلوها التام من الأخطاء أو عدم تغير أرقام الهواتف أو العناوين من قبل أصحاب الأماكن. استخدامك للمعلومات الواردة في الدليل يقع على مسؤوليتك الخاصة.
          </p>
        </div>
