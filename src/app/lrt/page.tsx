      ...
      <div className="metro-animate-fade" style={{
        ...
        <div className="metro-animate-slide-up metro-delay-100">
          <h1 style={{
            ...
            <img src="/images/searchBar/Cairo_lrt.png" alt="" style={{ width: "40px", height: "40px", marginLeft: "10px", objectFit: "contain" }} />
      ...
      <div style={{ maxWidth: "600px", margin: "0 auto", padding: "0 20px", direction: "rtl", textAlign: "right" }}>
        ...
        <div ref={searchContainerRef} className="metro-animate-slide-up metro-delay-200" style={{
          ...
          <div style={{ position: "relative" }}>
            <label style={{ fontSize: "0.85rem", fontWeight: "700", color: "var(--text-secondary)", display: "block", marginBottom: "8px" }}>
              <i className="fa-solid fa-magnifying-glass" style={{ marginLeft: "5px", color: "var(--accent-ios)" }}></i> ابحث في محطات القطار الكهربائي LRT
            </label>
            <input
              className="ios-input"
              type="text"
        ...
        <div className="metro-animate-slide-up metro-delay-200" style={{
          ...
          <h3 style={{ fontFamily: "var(--font-heading)", fontSize: "1.1rem", fontWeight: "700", color: "var(--text-primary)" }}>
            <i className="fa-solid fa-route" style={{ marginLeft: "5px", color: "var(--accent-ios)" }}></i> مخطط الرحلة وحساب التذاكر
          </h3>
              ...
              {showFromList && filteredFrom.length > 0 && (
                <div style={{
                  ...
                  {filteredFrom.map(s => (
                    ...
                    >
                      <span style={{ fontSize: "0.92rem", fontWeight: "600", color: "var(--text-primary)" }}>{s}</span>
                    </div>
                  ))}
                </div>
              )}
            ...
            {isTripActive && (
              <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                  <span style={{ fontSize: "0.78rem", fontWeight: "700", color: "var(--accent-ios)", background: "rgba(6, 182, 212, 0.12)", padding: "4px 10px", borderRadius: "8px" }}>
                    رحلة نشطة حالياً
                  </span>
                  <button
                    onClick={() => {
                ...
                {currentStepIndex < result.stations.length - 1 ? (
                  ...
                  <div style={{
                    ...
                    <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", margin: "0 0 12px" }}>لقد وصلت إلى وجهتك محطة <span style={{ color: "var(--accent-ios)", fontSize: "1rem", fontWeight: "800" }}>{result.stations[currentStepIndex]}</span>.</p>
                    <button
                      onClick={() => {
                        setIsTripActive(false);
                        setCurrentStepIndex(0);
        ...
        <div className="metro-animate-slide-up metro-delay-300" style={{ marginTop: "32px" }}>
          <h2 style={{
            ...
            marginBottom: "6px",
            textAlign: "center"
          }}>🗺️ مستعرض محطات القطار الكهربائي LRT</h2>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: active ? `2px solid ${tab.color}` : "1px solid var(--border-glass)",
                    borderRadius: "12px",
                    padding: "10px 4px",
                    cursor: "pointer",
                    transition: "all 0.2s ease",
                    ...
                    <div id={`station-${station.name}`} key={idx} style={{ display: "flex", flexDirection: "column", position: "relative" }}>
                      ...
                      <div
                        style={{
                          ...
                          height: "16px",
                          borderRadius: "50%",
                          background: details?.status === "تحت الإنشاء" ? "var(--bg-primary)" : color,
                          border: details?.status === "تحت الإنشاء" ? `3px dashed ${color}` : `4.5px solid var(--bg-primary, #000)`,
                          zIndex: 2,
        ...
        <div style={{
          ...
          <div style={{ fontSize: "0.78rem", color: "var(--text-secondary)", lineHeight: "1.5", marginTop: "8px", textAlign: "right", direction: "rtl" }}>
            • <strong style={{ color: "var(--accent-success)" }}>حتى 3 محطات:</strong> 10 جنيهات.
          </div>
          <div style={{ fontSize: "0.78rem", color: "var(--text-secondary)", lineHeight: "1.5", textAlign: "right", direction: "rtl" }}>
            • <strong style={{ color: "var(--accent-success)" }}>من 4 إلى 7 محطات:</strong> 15 جنيهاً.
          </div>
          <div style={{ fontSize: "0.78rem", color: "var(--text-secondary)", lineHeight: "1.5", textAlign: "right", direction: "rtl" }}>
