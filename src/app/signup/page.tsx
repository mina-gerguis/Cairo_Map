    ...
    <AuthLayout>
      <GlassCard style={{ padding: "32px 28px", animation: "slide-in-section 0.6s ease 0.1s both" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px" }}>
          ...
          >
            <i className="bx bx-right-arrow-alt" style={{ fontSize: "1.2rem" }}></i> رجوع للخلفف
          </button>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          <p style={{ fontSize: "0.85rem", color: "#64748b", margin: 0, fontFamily: "var(--font-sub)" }}>
            {current.subTitle}
          </p>
        </div>
        ...
        {/* Global Error Banner */}
        {error && (
          <div style={{ background: "#fef2f2", border: "1px solid #fecaca", borderRadius: "12px", padding: "10px 14px", color: "#dc2626", marginBottom: "18px", fontSize: "0.85rem", textAlign: "center", display: "flex", alignItems: "center", gap: "8px", justifyContent: "center", animation: "slide-in-section 0.3s ease", fontFamily: "var(--font-sub)" }}>
            <span>⚠️</span> {error}
          </div>
        )}
          ...
          <form onSubmit={
            ...
            {step === 5 && (
              <div style={{ display: "flex", flexDirection: "column", gap: "14px", animation: "slide-in-section 0.4s ease" }}>
                ...
                {/* Rules */}
                <div style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: "14px", padding: "14px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", fontSize: "0.8rem", fontFamily: "var(--font-sub)" }}>
                  {[
