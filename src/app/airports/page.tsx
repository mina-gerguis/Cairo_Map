                      ...
                      {airport.services && airport.services.length > 0 && (
                        <div>
                          <div style={{ color: "var(--text-primary)", fontWeight: "700", fontSize: "0.88rem", marginBottom: "6px", display: "flex", alignItems: "center", gap: "6px" }}>
                            <i className="bx bx-grid-alt" style={{ color: "var(--color-secondary)", fontSize: "1.1rem" }}></i>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      ...
                      {airport.official_website && (
                        <a
                          ...
                          style={{ color: "var(--color-secondary)", fontSize: "0.8rem", textDecoration: "none", fontWeight: "600", display: "inline-flex", alignItems: "center", gap: "3px" }}
                        >
          ...
          <div className="metro-animate-slide-up" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px", borderBottom: "1px solid var(--border-glass)", paddingBottom: "12px" }}>
                <i className="bx bx-receipt" style={{ color: "var(--color-secondary)", fontSize: "1.6rem" }}></i>
                <h3 className="sub-title" style={{ margin: 0, fontSize: "1.2rem", fontWeight: "700", color: "var(--text-primary)" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px", borderBottom: "1px solid var(--border-glass)", paddingBottom: "12px" }}>
                <i className="bx bx-buildings" style={{ color: "var(--color-secondary)", fontSize: "1.6rem" }}></i>
