          ...
          <div className="metro-animate-slide-up" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px", borderBottom: "1px solid var(--border-glass)", paddingBottom: "12px" }}>
                <i className="bx bx-receipt" style={{ color: "var(--accent-ios)", fontSize: "1.6rem" }}></i>
                <h3 style={{ margin: 0, fontSize: "1.2rem", fontWeight: "700", color: "var(--text-primary)", fontFamily: "var(--font-heading)" }}>
                  طرق وحجز تذاكر الطيران
                </h3>
              </div>
              
              <div>
                <h4 style={{ color: "var(--accent-ios)", fontSize: "0.95rem", fontWeight: "700", marginBottom: "8px" }}>🎒 طرق الحجز المتاحة:</h4>
                <ul style={{ paddingRight: "16px", margin: 0, fontSize: "0.88rem", color: "var(--text-secondary)", display: "flex", flexDirection: "column", gap: "8px", lineHeight: "1.7" }}>
                  <li>💻 <strong>المواقع والتطبيقات الرسمية لشركات الطيران:</strong> مثل <a href="https://www.egyptair.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>مصر للطيران</a>، و<a href="https://www.nileair.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>طيران النيل</a>، و<a href="https://www.airarabia.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>العربية للطيران</a>، إلخ. وهي الأضمن للحصول على أفضل سعر ودعم مباشر.</li>
                  <li>🌐 <strong>محركات البحث ومنصات المقارنة:</strong> مثل <a href="https://www.google.com/flights" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>Google Flights</a> و <a href="https://www.skyscanner.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>Skyscanner</a> و <a href="https://www.wego.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>Wego</a> لمقارنة الأسعار بين مختلف الشركات واختيار الرحلة الأنسب.</li>
                  <li>📱 <strong>تطبيقات وكالات السفر عبر الإنترنت:</strong> مثل <a href="https://www.booking.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>Booking.com</a> و <a href="https://www.expedia.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>Expedia</a> و <a href="https://www.trip.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>Trip.com</a> و <a href="https://www.almosafer.com" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-ios)", textDecoration: "underline" }}>Almosafer</a> للبحث عن عروض تشمل الطيران والفنادق.</li>
              ...
              <div style={{ marginTop: "8px", borderTop: "1px dashed var(--border-glass)", paddingTop: "12px" }}>
                <h4 style={{ color: "var(--accent-ios)", fontSize: "0.95rem", fontWeight: "700", marginBottom: "8px" }}>📝 خطوات حجز التذكرة إلكترونياً:</h4>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px", borderBottom: "1px solid var(--border-glass)", paddingBottom: "12px" }}>
                <i className="bx bx-buildings" style={{ color: "var(--accent-ios)", fontSize: "1.6rem" }}></i>
                <h3 style={{ margin: 0, fontSize: "1.2rem", fontWeight: "700", color: "var(--text-primary)", fontFamily: "var(--font-heading)" }}>
                  تعليمات دخول المطار والمستندات المطلوبة
                </h3>
              </div>
              
              <div>
                <h4 style={{ color: "var(--accent-ios)", fontSize: "0.95rem", fontWeight: "700", marginBottom: "8px" }}>🛂 المستندات اللازمة والضرورية (اللازم منه):</h4>
                <ul style={{ paddingRight: "16px", margin: 0, fontSize: "0.88rem", color: "var(--text-secondary)", display: "flex", flexDirection: "column", gap: "8px", lineHeight: "1.7" }}>
              ...
              <div style={{ marginTop: "8px", borderTop: "1px dashed var(--border-glass)", paddingTop: "12px" }}>
                <h4 style={{ color: "var(--accent-ios)", fontSize: "0.95rem", fontWeight: "700", marginBottom: "8px" }}>🚶‍♂️ الخطوات والتعليمات داخل المطار:</h4>
                <ol style={{ paddingRight: "16px", margin: 0, fontSize: "0.88rem", color: "var(--text-secondary)", display: "flex", flexDirection: "column", gap: "8px", lineHeight: "1.7" }}>
