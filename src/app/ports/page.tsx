...
export default function PortsPage() {
  ...
  if (authLoading) {
    return (
      <div style={{ minHeight: "100vh", backgroundColor: "var(--bg-primary)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "20px", direction: "rtl" }}>
        <div style={{
          width: "40px",
          height: "40px",
        ...
        <div className="metro-animate-fade" style={{
          ...
          <div className="metro-animate-slide-up metro-delay-100">
            <h1 style={{
              ...
              <img src="/images/searchBar/arab_republice.png" alt="arab_republice" style={{ width: "35px", height: "35px", marginLeft: "10px" }} />
              ...
              {user ? (
                <Link
                  ...
                  style={{
                    ...
                    fontWeight: "bold",
                    fontSize: "0.95rem",
                    boxShadow: "0 4px 15px var(--bs-subscribe-button-gold)",
                    display: "block"
                  }}
                >
      ...
      <div className="metro-animate-fade" style={{
        ...
        <div className="metro-animate-slide-up metro-delay-100">
          <h1 style={{
            ...
            <img src="/images/searchBar/arab_republice.png" alt="arab_republice" style={{ width: "55px", marginLeft: "10px" }} />
            دليل الموانئ البحرية
          </h1>
        ...
        <div className="metro-animate-slide-up metro-delay-200" style={{
          ...
          <div ref={searchContainerRef} style={{ position: "relative" }}>
            <label style={{ fontSize: "0.85rem", fontWeight: "700", color: "var(--text-secondary)", display: "block", marginBottom: "8px" }}>
              <i className="fa-solid fa-magnifying-glass" style={{ marginLeft: "5px", color: "var(--accent-ios)" }}></i> ابحث في دليل الموانئ
            </label>
            <input
              className="ios-input"
              type="text"
          ...
          <div style={{ display: "flex", gap: "8px", overflowX: "auto", paddingBottom: "4px" }}>
            <button
              ...
              style={{
                ...
                fontWeight: "700",
                border: "1px solid var(--border-glass)",
                background: selectedFilter === "all" ? "var(--accent-ios)" : "var(--bg-secondary)",
            ...
            filteredPorts.map((port, idx) => {
              ...
              return (
                <div
                  ...
                  style={{
                    backgroundColor: "var(--bg-primary)",
                    border: isExpanded ? "1px solid var(--accent-ios)" : "1px solid var(--border-glass)",
                    borderRadius: "15px",
                    padding: "20px",
                    boxShadow: "var(--shadow-card)",
